...
ENV PYTHONUNBUFFERED=1 \
    ...
    QWEN_MAX_INPUT_LONG_SIDE=1080 \
    QWEN_AUTO_TARGET_LONG_SIDE=1080 \
    QWEN_DEFAULT_MASK_EXPAND_PIXELS=0 \
    QWEN_DEFAULT_MASK_BLEND_PIXELS=2 \
    QWEN_DEFAULT_CONTEXT_EXPAND_FACTOR=1.15 \
